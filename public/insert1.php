...
<header class="header">
	...
	<div class="output">
		...
		/*$sql = "INSERT INTO productdata1 VALUES ('$pname',
			'$prate','$pquan')";
		
		if(mysqli_query($conn, $sql)){
			echo "<h3>Product Data stored in a database successfully.</h3>";

			echo nl2br("Product Name:$pname\n Rate:$prate\n "
				. "Quantity:$pquan\n");
		} 
		else{
			echo "<h3>Product Data Already stored in a database successfully.</h3>";
		}
		
		// Close connection
		mysqli_close($conn);/** */
    $pname = $_REQUEST['pname'];
$query_login = "SELECT pname FROM productdata1 WHERE pname='$pname';";
$sql = "INSERT INTO productdata1 VALUES ('$pname','$prate','$pquan')";
...
if($anything_found>0)
    {
    echo "Sorry, that product name is already there. Please choose another.\n";
   }
   ...
   mysqli_close($conn);
    ...
    <br><br>
        <a href ="index1.html">
			...
			<a href="pro_detail.php">
			<button>View product Details</button></a>
