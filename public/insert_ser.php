...
<header class="header">
	...
	<div class="output">
		...
		/*$sql = "INSERT INTO service VALUES ('$sname','$scost')";
		
		if(mysqli_query($conn, $sql)){
			echo "<h3>Data stored in a database successfully.</h3>";

			echo nl2br("Service Name:$sname \n Service Cost:$scost\n");
		} else{
		
			echo "<h3>This is already stored in a database successfully."
		...
		mysqli_close($conn);/** */
    $sname = $_REQUEST['sname'];
$query_login = "SELECT sname FROM service WHERE sname='$sname';";
$sql = "INSERT INTO service VALUES ('$sname','$scost')";
   ...
   mysqli_close($conn);
    ...
    <br><br>
        <a href ="index1.html">
			...
			<button>View Service Details</button></a>
      <a href="create_ser.html">
